...
export default function GalleryPage({ onNav }) {
  ...
  return (
      <HeadProvider>
    <Title>Our Work – Signage & Branding Gallery</Title>
    <Meta
      name="description"
      content="See our amazing signage and branding projects in Kochi and Kerala — LED signs, acrylic letters, indoor & outdoor projects showing dedication to quality and creativity."
    />
    <>
      {/* ------------------------------------------------------ */}
