...
export default function AboutUsPage({ onNav }) {
  ...
  return (
    <HeadProvider>
      {/* 🔥 SEO META TAGS */}
      <Title>About Next Level Signages | Kochi’s Leading Signboard & Branding Company</Title>
      <Meta
        name="description"
        content="Next Level Signages is a trusted name in Kochi for signs and branding. We specialize in LED boards, acrylic letters, and more. Our team has years of experience in creating innovative and lasting branding solutions."
      />
        ...
        <div className="max-w-7xl mx-auto mt-32 md:mt-40">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                To be the leading provider of integrated signage solutions across Kerala & soon other states — setting industry standards for quality, innovation & brand elevation.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                To design, manufacture, and install high-impact, durable & technologically advanced signages that strengthen business visibility and customer engagement.
              </p>
            </motion.div>
